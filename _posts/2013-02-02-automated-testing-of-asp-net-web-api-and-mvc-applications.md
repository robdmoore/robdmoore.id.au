...
- **Controller Instantiation**: [As previously blogged](/blog/2012/05/29/controller-instantiation-testing/).
- **Filters, Filter Providers and Model Binders**: I will typically unit test these, for an example see my previous post about [unit testing filter providers](/blog/2012/04/27/testing-code-that-uses-autofac-dependencyresolver-in-asp-net-mvc/).
